...
public class BenefitAdapter extends BaseAdapter {
	...
	public BenefitAdapter(Context context, List<BenefitEntity> list, ListView listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			viewHolder.id.setText(list.get(position).getUnitId());
			viewHolder.name.setText(list.get(position).getBenName());
			viewHolder.info.setText(list.get(position).getBenCond());
			// 显示图片
	...
	SyncImageLoader.OnImageLoadListener imageLoadListener = new SyncImageLoader.OnImageLoadListener() {
		...
		public void onError(Integer t) {
			BenefitEntity entity = (BenefitEntity) getItem(t);
