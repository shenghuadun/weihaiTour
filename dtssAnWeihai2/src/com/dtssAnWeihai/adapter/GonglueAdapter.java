...
public class GonglueAdapter extends BaseAdapter {
	...
	public GonglueAdapter(Context context, List<GonglueEntity> list, ListView listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			viewHolder.info.setText(list.get(position).getType());
			// 显示图片
	...
	SyncImageLoader.OnImageLoadListener imageLoadListener = new SyncImageLoader.OnImageLoadListener() {
		...
		public void onError(Integer t) {
			GonglueEntity entity = (GonglueEntity) getItem(t);
