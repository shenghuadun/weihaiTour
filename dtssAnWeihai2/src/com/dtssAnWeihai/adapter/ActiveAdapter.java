...
public class ActiveAdapter extends BaseAdapter {
	...
	private List<ActiveEntity> list = new ArrayList<ActiveEntity>();
	private ListView listView;
	SyncImageLoader syncImageLoader;

	public ActiveAdapter(Context context, List<ActiveEntity> list, ListView listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			viewHolder.name.setText(list.get(position).getActName());
			viewHolder.info.setText(list.get(position).getActTime());
			// 显示图片
